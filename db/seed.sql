-- Seed all data: user, notes, labels, and note_labels
-- This seed file creates one test user and all sample data
...
-- Insert notes (all belong to the test user)
INSERT INTO notes (id, user_id, "order", title, content, color_id, is_pinned, is_archived, is_trashed, created_at) VALUES 
  ...
  ('10000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', 5, 'Ideas for Project', 'Feature ideas: dark mode, search, filters', 'purple', false, false, false, '2024-01-01 10:00:00'),
  ('10000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000001', 6, 'Archived Note', 'This note is archived', 'default', false, true, false, '2024-01-01 10:00:00'),
  ('10000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000001', 7, 'Important Task', 'Complete the backend API by Friday', 'red', true, false, false, '2024-01-01 10:00:00');

-- Insert labels (all belong to the test user)
INSERT INTO labels (id, user_id, name, created_at) VALUES 
  ...
  ('20000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'Ideas', '2024-01-01 07:00:00'),
  ('20000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', 'Important', '2024-01-01 06:00:00'),
  ('20000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000001', 'Urgent', '2024-01-01 05:00:00'),
  ('20000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000001', 'Archive', '2024-01-01 04:00:00');
...
INSERT INTO note_labels (note_id, label_id) VALUES 
  ...
  ('10000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000005'), -- Meeting Notes -> Important
  ...
  ('10000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000005'), -- Important Task -> Important
  ('10000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000006'), -- Important Task -> Urgent
  ('10000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000007'); -- Archived Note -> Archive
