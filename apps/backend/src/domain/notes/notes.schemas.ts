...
export type RemoveLabelFromNoteParams = z.infer<typeof removeLabelFromNoteSchema.params>;
export type CreateLabelAndAddToNoteParams = z.infer<typeof createLabelAndAddToNoteSchema.params>;
