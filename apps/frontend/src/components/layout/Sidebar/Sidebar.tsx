...
const SidebarItem = ({
  ...
  <a
    href={url}
    className={cn(
      'transition-width flex items-center gap-x-8 overflow-hidden rounded-full py-3 text-sm font-medium duration-100 ease-in-out',
...
const Sidebar = ({ isMobile }: SidebarProps) => {
  ...
  return (
    <aside
      className={cn(
        'bg-base group fixed left-0 z-10 flex h-full flex-col py-2',
        isSidebarCollapsed
